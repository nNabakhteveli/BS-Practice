...
namespace ExceptionHandling
{
    public static class ThrowingExceptions
    {
        ...
        public static int CheckCandidateAgeAndThrowException(int candidateAge, bool isCandidateWoman)
        {
            ...
            return isCandidateWoman switch
            {
                false when candidateAge > 63 => throw new ArgumentOutOfRangeException(nameof(candidateAge)),
                true when candidateAge > 58 => throw new ArgumentOutOfRangeException(nameof(candidateAge)),
                _ => candidateAge
            };
        }
