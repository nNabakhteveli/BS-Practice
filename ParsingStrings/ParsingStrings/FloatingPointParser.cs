...
namespace ParsingStrings
{
    public static class FloatingPointParser
    {
        ...
        public static bool TryParseFloat(string str, out float result) => float.TryParse(str, out result);
        ...
        /// <returns>true if <paramref name="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseDouble(string str, out double result) => double.TryParse(str, out result);
        ...
        /// <returns>true if <paramref name="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseDecimal(string str, out decimal result) => decimal.TryParse(str, out result);
