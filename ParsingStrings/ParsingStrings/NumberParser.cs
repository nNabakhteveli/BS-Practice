...
namespace ParsingStrings
{
    public static class NumberParser
    {
        ...
        public static bool TryParseInteger(string str, out int result) => int.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseUnsignedInteger(string str, out uint result) => uint.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseByte(string str, out byte result) => byte.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TrySignedByte(string str, out sbyte result) => sbyte.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseShort(string str, out short result) => short.TryParse(str, out result);
        ...
        public static short ParseShort(string str) => short.Parse(str);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseUnsignedShort(string str, out ushort result) => ushort.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseLong(string str, out long result) => long.TryParse(str, out result);
        ...
        /// <returns>true if <see cref="str"/> was converted successfully; otherwise, false.</returns>
        public static bool TryParseUnsignedLong(string str, out ulong result) => ulong.TryParse(str, out result);
        ...
        public static ulong ParseUnsignedLong(string str) => ulong.Parse(str);
    }
}
