...
namespace Linq
{
    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<int> Union()
        {
            ...
            return numbersA.Union(numbersB).Distinct();
        }
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            var listOfProds = products.Select(prod => prod.ProductName[0]).Distinct();
            var listOfCustomers = customers.Select(customer => customer.CompanyName[0]).Distinct();

            return listOfProds.Union(listOfCustomers);
        }
        ...
        public static IEnumerable<char> IntersectQueryResults()
        {
            ...
            var listOfProds = products.Select(prod => prod.ProductName[0]);
            var listOfCustomers = customers.Select(customer => customer.CompanyName[0]);

            return listOfProds.Intersect(listOfCustomers);
        }
        ...
        public static IEnumerable<char> DifferenceOfQueries()
        {
            ...
            return listOfProds.Except(listOfCustomers);
        }
    }
}