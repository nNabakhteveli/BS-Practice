...
namespace Linq
{
    ...
    public static class FilteringData
    {
        ...
        public static IEnumerable<int> LowNumbers()
        {
            ...
            return numbers.Where(num => num < 5);
        }
        ...
        public static IEnumerable<Product> ExpensiveProductsInStock()
        {
            ...
            return products.Where(product => product.UnitsInStock > 0 && product.UnitPrice > 50.0m);
        }
        ...
        public static IEnumerable<string> IndexedWhere()
        {
            ...
            return digits.Where(digit => digit.Length < Array.IndexOf(digits, digit));
        }
    }
}