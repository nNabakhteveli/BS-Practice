...
namespace Linq
{
    ...
    public static class SortingData
    {
        ...
        public static IEnumerable<Product> OrderProductsDescending()
        {
            ...
            return products.OrderByDescending(product => product.UnitsInStock);
        }
        ...
        public static IEnumerable<string> ThenBy()
        {
            ...
            return digits.OrderBy(digit => digit.Length).ThenBy(digit => digit);
        }
        ...
        public static IEnumerable<Product> ThenByDifferentOrdering()
        {
            ...
            return products.OrderBy(product => product.Category).ThenByDescending(product => product.UnitPrice);
        }
        ...
        public static IEnumerable<string> CustomThenByDescending()
        {
            ...
            return words.OrderBy(word => word.Length).ThenByDescending(word => word);
        }
        ...
        public static IEnumerable<string> OrderingReversal()
        {
            ...
            return digits.Where(digit => digit[1] == 'i').Reverse();
        }
    }
}